  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Browse Books<span class="caret"></span></a>
        <ul class="dropdown-menu">
          ...
          <li><a href="best_seller.php"> By Best Selling</a></li>
    ...
    <?php
				...
				if(!isset($_SESSION['username'])){
					...
					<li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="Profile/Profile.php">'.$_SESSION['username']. '<span class="caret"></span></a>
	        				<ul class="dropdown-menu">
